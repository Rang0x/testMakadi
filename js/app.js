...
$(document).ready(function () {
    function changeMobileInput(inputId, cCode) {
      ...
      $(phoneInputID).on("countrychange", function (event) {
        ...
        selectedCountryCode = selectedCountryData.dialCode;
    ...
    changeMobileInput("phone4", "country-code-4");
  });
...
document.addEventListener("mousemove", function (e) {
    ...
    function handleForm(e) {
      ...
      let formData = new FormData(myForm);
        formData.append("Country Code ", selectedCountryCode)
    ...
    loader.classList.replace("d-none", "d-flex"),
      fetch("https://sendmail-api-docs.vercel.app/api/send", {
        method: "POST",
        body: JSON.stringify({
          to: ["rengawy1@gmail.com" , "clematisegypt@gmail.com"],
          subject: "NEW LEAD!",
          message: `New Lead ${formattedData}`
        })
      })
      .then(() => loader.classList.replace("d-flex", "d-none"))
